...
class CoachGigForPlayer extends StatefulWidget {
  const CoachGigForPlayer({Key? key}) : super(key: key);

  @override
  State<CoachGigForPlayer> createState() => _CoachGigForPlayerState();
}

class _CoachGigForPlayerState extends State<CoachGigForPlayer> {
  @override
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'I will be your professional Football Coach',
                              style: GoogleFonts.syne(color: Colors.purple),
                            ),
                          ],
                        ),
                      ),
